      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              Text(agent.description!,style: const TextStyle(color: white,),textAlign: TextAlign.start,),
            ],
          ),
        )
      ],
    ...
    Positioned(
      ...
      children: [
        Text(
          agent.displayName!,
          style: TextStyle(
              fontFamily: 'Valorant', color: white, fontSize: 50.sp,fontWeight: FontWeight.w600),
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.end,
          children: [
            CachedNetworkImage(imageUrl: agent.role!.displayIcon!,width: 12.5.w,),
            SizedBox(width: 5.w,),
            Padding(
